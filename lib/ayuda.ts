...
export const ARTICULOS: Articulo[] = [
...

  {
    ...
    cuerpo:
      "Tenés 5 días de tolerancia desde el vencimiento. En ese tiempo el sistema anda igual, con un recordatorio arriba del panel.\n\nCómo va:\n• El día del vencimiento: \"hoy vence tu abono\".\n• Los dos días siguientes: te decimos hasta cuándo tenés, sin apuro.\n• A los 3 días: te avisamos la fecha exacta.\n• A los 4 días: \"mañana se te pausa el sistema\".\n• A los 5 días: el panel queda en pausa.\n\nEn pausa NO se pierde nada: tus socios, tus cobros, tus clases y tus rutinas quedan intactos, y tus socios siguen usando su app con total normalidad. La pausa es solo para el panel del dueño, y se destraba en el momento en que entra el pago.\n\nPara abonar: Panel → Mi plan → Abonar. Con Mercado Pago se activa al instante; por transferencia subís el comprobante y lo activamos a mano.\n\nY si este mes se te complicó, escribinos antes de que llegue la fecha: se arregla. Preferimos mil veces que nos avises a que te quedes sin el sistema.",
  },
  {
